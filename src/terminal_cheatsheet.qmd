...
push the down arrow to see examples.
:::
...
| Make nested directories | `mkdir -p ~/nr218/lab_02_first_map/data` | `mkdir ~\nr218\lab_02_first_map\data` |
...
## If you ever need help {style="font-size:0.6em"}

Look at the man pages (man is short for manual)
