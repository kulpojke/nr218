...
In Lab 6 you have been working with the two Sentinel 2 datasets.  You should already have them, but if not they can be downloaded with the links below.
...
In Lab 6 you are asked to segment the image to find lithium brine evaporation ponds near Susques, Argentina.
:::
...
+ Calculate you index.
+ Use Raster Calculator to create a binary mask of values above a threshold,
e.g. `INDEX > 0`
+ Polyginize the results
:::
...
If that link happens to be broken [use this copy](https://cpslo-my.sharepoint.com/:u:/g/personal/mthuggin_calpoly_edu/IQBeiacNuqIoSYrAWf2JRaSSAXDJR7wWVCmpr7RUuyeqNPA?e=XAJsah).
:::
...
+ Run with 3 clusters, and _class_ as the value "Fields to use for clustering"
