---
title: "lab 5: A Quick Lesson in Multi-band Rasters Using NAIP
"
page-layout: full
format: 
  html:
...
Create a working directory, called `lab_05_NAIP`, for this lab in your `nr218` folder. Create a `data` folder and put the downloaded data inside. Then:

+ Open QGIS and start a new project
+ Change the project CRS to EPSG:6339
+ Save it in the `lab_05_NAIP` folder as `coffee_fire.qgz`

Also create a text document (using Notepad, TextEdit, gedit, or similar), name it `answers.txt`, and save it in `lab_05_NAIP`. Throughout this lab there will be questions included in the format of the text below. Answer the questions in `answers.txt`.
...
As usual, zip you lab_05_NAIP directory and submit to Canvas.  
