...
For this lab you should <strong><u>turn in the text document you create in steps 8, and 9 of Task 1</u></strong> on Canvas.  You do not have to turn in anything for Task 2, but you will need to have your OneDrive configured properly for the rest of the quarter.
...
8. Create a document in a text editor (e.g. notepad on Windows). Name it `gustav_adolf_lab1.txt` (use your own name, not Gustov Adolf's name) and save it in `~/nr218`.
