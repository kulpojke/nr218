# Vector Operations and Geoprocessing
...
::: {style="font-size:0.6em; line-height:1.1; margin-bottom:0.1em;"}   
...
<img src="img/degree_buf.png" alt="QGIS warning about buffering in degrees" style="display:block; margin:0 auto; max-width:100%; max-height:40vh; object-fit:contain;" />
:::
:::
...
::: {style="line-height:0; margin:0;"}
<img src="img/joins_image0.png" alt="Schematic illustration of tabular joins" style="display:block; margin:0 auto; max-width:100%; max-height:40vh; object-fit:contain;" />  
...
::: {style="line-height:0; margin:0;"}
<img src="img/spatial-join-basic-idea.png" alt="Schematic illustration of spatial joins" style="display:block; margin:0 auto; max-width:100%; max-height:40vh; object-fit:contain;" />  
...
4. In the Processing Toolbox search "join" and select "join attributes by field"
    + Input layer 1 is counties, input layer 2 is the income CSV  
...
Download California cities [here](https://gis.data.ca.gov/api/download/v1/items/8cd5d2038c5547ba911eea7bec48e28b/geojson?layers=2) or from [this link] (https://raw.githubusercontent.com/kulpojke/nr218/main/assets//California_Cities_and_Identifiers_Blue_Version_view_9179458143702591125.geojson)
...
::: {.fragment .absolute .fade-out data-fragment-index="1"}
+ Right-click [this link](https://raw.githubusercontent.com/kulpojke/nr218/main/assets/some_f___ed_up_farm_fields.geojson) and use _save link as_ to download some totally messed up farm fields.  
+ Also right-click [this link](https://raw.githubusercontent.com/kulpojke/nr218/main/assets/meaningless_points.geojson) and use _save link as_ to download some meaningless points.  
:::

::: {.fragment .absolute .fade-in-then-out data-fragment-index="1"}
+ Click _Pluggins_ >_Manage and Install Pluggins_, type "topology che", and check the box next to Topology Checker.
+ In your toolbar the Topoly Checker button, ![](img/mActionTopologyChecker.png), should appear. Click it.
+ Then click the Configure button, ![](img/mActionOptions.png).
:::
...
+ Now, click the Validate all button, ![](img/mActionValidateAll.png)
:::  
:::

::: {.fragment .absolute .fade-in-then-out data-fragment-index="4"}
![](img/topology_faux_pas.png)
...
## Digitizing to create secondary vector data

+ Tablet
  + Tracing on a light table with specialized hardware, then 
+ Heads up 
  - Clicking and drawing in GIS software
+ Automated
  - Many different form, some simple some complex