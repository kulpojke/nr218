...
Use the dropdown menus to add rules.  When you create a rule, you must use the plus button to add it before you close the window by hitting "OK"

Try the following,
meaningless_points musst be inside some_f___ed_up_farm_fields
