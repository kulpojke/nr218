...
![Download list icon](img/lidar_exp_download_list.png){#fig-download-list fig-alt="Image showing the download list icon to the right of OPR" fig-cap="Download list icon is to the right of OPR" .wrap-right style="--wrap-width:35%;"}

For Anacapa there should be 18 tiles under _DEM Source (OPR)_. You _could_ click each one and download it, kind of a pain though.  If you were working on a larger area, clicking and downloading each file would not be practical.  Luckily, there is a download list which can be downloaded by pressing the _Download List_ button shown in @fig-download-list.

<details>
<summary>Read this ii Lidar Explorer is Broken</summary>
