...
Make a new folder inside your `nr218` directory called `lab_8`. Inside that folder, make a `data` folder. All downloaded files will go in the `data` folder You should have a directory structure as shown below. 
