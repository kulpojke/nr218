...
| MNDWI | (Green - SWIR1) / (Green + SWIR1) | (B3 - B11) / (B3 + B11) | Open water detection |
...
+ Ok, so _there is an index for that_, how do you find it?
+ Do some dang research!
  + Papers describing spectral indices
  + There are good resources on the internet as well such as:
    + Awesome Spectral Indices [table of indices](https://github.com/awesome-spectral-indices/awesome-spectral-indices/blob/main/output/spectral-indices-table.csv)
    + Awesome Spectral Indices [webpage](https://awesome-ee-spectral-indices.readthedocs.io/en/latest/index.html#expressions), which explains some coefficients found in the indices
:::

## What if there is no index for that?
Dang! none of these indices are doing what I want!

::: {.incremental style="font-size:0.5em"}
+ You can also make a custom index
  + Usually best to start with an existing index
  + Tweak some bands based on there properties
    + Here is [a resource](https://gisgeography.com/spectral-signature/) for that, Peer reviewed papers are more definitive though
...
[Lets work through this example](https://github.com/kulpojke/nr218/blob/main/docs/NDHI.html)
