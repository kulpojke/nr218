...
11. Now lets view it as False color
    a. Recall from earlier, that is NIR, G, R
    b. Open symbology and change the band order
12. Calculate Normalized Difference Vegetation Index

    a. Open Raster Calculator ( _Raster_ -> _Raster Calculator_)
    b . enter ` ( "naip_2022_clipped@4"  - "naip_2022_clipped@1" )  /  ( "naip_2022_clipped@4" + "naip_2022_clipped@1" )` 
    c. check the "create on the fly raster ..." box at the top under "Result Layer"
    d. Run
