...
+ __Match resolutions__ - So multiple rasters will align for analyisis (e.g., NDVI and elevation) [^match]
...
::: {style="font-size:0.5em"}
[^match]: Resampling does not necessarily align pixels between rasters, though this option can be specified in certain resampling algorithms.
:::
