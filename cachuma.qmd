...
$$ 
V_{total} = \sum_{n=0}^{n} V_{n}
$$ {#eq-total}

where the volume of the slice $V_{n}$ is approximated by the depth of the slice $\Delta z$ times the mean area of the top ($A_{n}+A_{n+1}$) and bottom ($A_{n}+A_{n}$) of the slice, and $V_{total}$ is the sum of all the slices.  @fig-schem shows a schematic representation of the volume approximation method.
