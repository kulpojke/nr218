...
A path is a string that uniquely identifies an item in . Generally, a path is composed of directory names, special format specifiers, and optionally a filename, all separated by delimiters.  
