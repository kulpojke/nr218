...
::: {.fragment .absolute .fade-in-then-out data-fragment-index=5 style="text-align: center; font-size:1.2em"}
<span style="color: red;">-</span>128.681123
:::
...
&nbsp;&nbsp;&nbsp; $\circ$ As defined by its gravity field rather than its topography [^1]
:::

::: {.fragment .fade-in data-fragment-index=4 style="font-size:0.6em"}    
&nbsp;&nbsp;&nbsp; $\circ$ Gravity field found by finding equipotential surfaces
:::

::: {.fragment .fade-in data-fragment-index=4 style="font-size:0.6em"}    
&nbsp;&nbsp;&nbsp; $\circ$ _The_ geoid Specific equipotential surface that best approximates
...
[^1]: [Janssen, Volker. "Understanding coordinate reference systems, datums and transformations." (2009).](https://figshare.utas.edu.au/articles/journal_contribution/Understanding_coordinate_reference_systems_datums_and_transformations/22873136/1?file=40609577)
...
+  so the surface is approximated using a  
_spheroid_ (also called an ellipsoid of revolution) 
+ Some spheroids are suited for global use, others for local use
:::

::: {.column width="60%"}
:::  {r-srack}
::: {.fragment .fade-in-then-out .absloute}
![](img/GRAVIMETRIC_DATUM_ORIENTATION.png){style="position: absolute; right: 0px; top: 70px; width: 300px;"}
:::
...
![](https://imgs.xkcd.com/comics/map_projections.png){style="position: absolute; right: 20px; top: 0px; width: 500px;"}