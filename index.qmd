...
Data in a file are separated by a ‘delimiter’, such as a comma,
tab, space, etc. For example:

+ [file.csv]{data-id="csv-item"}

:::{.fragment data-id="csv-item" style="padding: 2px 4px; border-radius: 3px;"}
```
Country, Population, Language, Continent, Centroid
France, 65000000, French, Europe, "2.2137, 46.2276"
Brazil, 192000000, Portuguese, South America, "-47.8825, -15.7942"
Australia, 22000000, English, Australia, "133.7751, -25.2744"
```
:::
...
::: {style="font-size: 0.5em"}
[link to file](https://github.com/kulpojke/nr218/blob/main/assets/countries.csv)(to download, use the ![](img/downloa_button.png){style="vertical-align: middle;"} button on right)
:::
