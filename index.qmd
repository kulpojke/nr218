...
:::{.fragment .fade-in style="position: absolute;"}
![](img/qgis_data_source_manager.png){height="350"}
:::

:::{.fragment .fade-in style="position: absolute; top: 165px; left: 0; width: 325px; height: 20px; border: 2px solid red; background: rgba(255,0,0,0.2); pointer-events: none;"}
:::

:::{.fragment .fade-out style="position: absolute;"}
:::
