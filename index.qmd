...
::: {style="display: grid; grid-template-columns: 1fr 1fr; grid-template-rows: 1fr 1fr; gap: 10px; margin-top: 20px;"}
...
![](img/File_Dymaxion_projection.png){style="width: 100%; height: auto; object-fit: contain;"}
![](img/File_Dymaxion_with_Tissot's_Indicatrices_of_Distortion.svg){style="width: 100%; height: auto; object-fit: contain;"}
:::
:::
